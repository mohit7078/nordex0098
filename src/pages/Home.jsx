...
export class Home extends Component {
  ...
  ============================================= */}	
      <div id="page" className="page">
        {/* HEADER
    ============================================= */}
        <header id="header" className="header tra-menu navbar-light hidden-nav">
          <div className="header-wrapper">
            ...
            <div className="wsmainfull menu clearfix">
              <div className="wsmainwp clearfix">
                {/* HEADER LOGO */}
                <div className="desktoplogo"><a href="#hero-1" className="logo-black"><img src={logo} alt="header-logo" /></a></div>
                <div className="desktoplogo"><a href="#hero-1" className="logo-white"><img src={logo_white} alt="header-logo" /></a></div>
                {/* MAIN MENU */}
                  ...
                  <ul className="wsmenu-list nav-rose-hover">
                    ...
                    <li aria-haspopup="true"><a href="#">About <span className="wsarrow" /></a>
                      <ul className="sub-menu">
                        <li aria-haspopup="true"><a href="#features-4">About NordEx</a></li>
                        <li aria-haspopup="true"><a href="#content-3">Best Solutions</a></li>
                        <li aria-haspopup="true"><a href="#content-5">Why Choose Us</a></li>
                        <li aria-haspopup="true"><a href="#content-1">App Integration</a></li>	
                        <li aria-haspopup="true"><a href="#reviews-4">Testimonials</a></li>	  
                      </ul>
                    </li>
                    {/* SIMPLE NAVIGATION LINK */}
                    <li className="nl-simple" aria-haspopup="true"><a href="#features-5">Features</a></li>
                    {/* DROPDOWN MENU */}
                    ...
                    {/* SIMPLE NAVIGATION LINK */} 
                    <li className="nl-simple" aria-haspopup="true"><a href="#faqs-1">FAQs</a></li>
                    {/* SIMPLE NAVIGATION LINK */} 
                    <li className="nl-simple" aria-haspopup="true"><a href="#more-apps-1">More Apps</a></li>
                    {/* SIMPLE NAVIGATION LINK */} 
                    <li className="nl-simple" aria-haspopup="true"><a href="#blog-1">Blog</a></li>
                    {/* HEADER BUTTON */}
                    <li className="nl-simple" aria-haspopup="true">
                      <a href="#download-6" className="btn btn-rose tra-grey-hover last-link">Let's Started</a>
                    </li> 
                    {/* APPSTORE BADGE 
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-md-7 col-lg-6">
                <div className="hero-1-txt pl-25 wow fadeInRight" data-wow-delay="0.6s">
                  {/* App Logo */}
                  <div className="hero-app-logo"><img className="img-fluid" src={app_logo} alt="hero-app-logo" /></div>
                  {/* Title */}
              ...
              <div className="col-md-5 col-lg-6">	
                <div className="hero-1-img text-center wow fadeInLeft" data-wow-delay="0.6s">
                  <img className="img-fluid" src={hero_1_img} alt="hero-image" />
                </div>
              </div>	
            </div>  {/* End row */}		 											
          </div>	{/* END HERO-1 CONTENT */}	
          {/* SECTION OVERLAY */}	
              ...
              <div className="row d-flex align-items-center">
                ...
                <div className="col-md-5 col-lg-6">
                  <div className="img-block left-column pc-25 mb-40 wow fadeInRight" data-wow-delay="0.6s">
                    <img className="img-fluid" src={img_11} alt="content-image" />
                  </div>
                </div>
                {/* TEXT BLOCK */}	
                <div className="col-md-7 col-lg-6">
              ...
              <div className="row d-flex align-items-center m-row">
                ...
                <div className="col-md-5 col-lg-6 m-top">
                  <div className="img-block right-column pc-15 mb-40 wow fadeInLeft" data-wow-delay="0.6s">
                    <img className="img-fluid" src={img_05} alt="content-image" />
                  </div>
                </div>
              </div>  {/* End row */}	
              ...
              <div className="row d-flex align-items-center">
                ...
                <div className="col-md-5 col-lg-6">
                  <div className="content-5-img right-column pc-20 text-center wow fadeInRight" data-wow-delay="0.6s">
                    <img className="img-fluid" src={img_04} alt="content-image" />
                  </div>
                </div>
                {/* TEXT BLOCK */}
                <div className="col-md-7 col-lg-6">
            ...
            <div className="row d-flex align-items-center m-row">
                ...
                <div className="txt-block left-column mb-40 wow fadeInRight" data-wow-delay="0.6s">
                  ...
                  <ul className="simple-list">
                    <li className="list-item">
                      <p className="p-lg">Fringilla risus, luctus mauris orci auctor purus euismod pretium purus pretium ligula rutrum tempor sapien
                      </p>
                    </li>
                    <li className="list-item">
                    ...
                    <li className="list-item">
                      <p className="p-lg">Nemo ipsam egestas volute turpis dolores ut aliquam quaerat sodales sapien undo pretium a purus mauris
                      </p>
                    </li>
                  </ul>
                </div>
              ...
              <div className="col-md-5 col-lg-6 m-top">
                <div className="img-block right-column pc-20 mb-40 wow fadeInLeft" data-wow-delay="0.6s">
                  <img className="img-fluid" src={img_02} alt="content-image" />
                </div>
              </div>
            </div>	   {/* End row */}
          </div>	   {/* End container */}
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="img-block text-center wow fadeInUp" data-wow-delay="0.6s">
                  <img className="img-fluid" src={socials} alt="content-image" />
                </div>
              </div>
            </div>
            {/* DOWNLOAD BUTTON */}		
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-md-5 col-lg-6">
                <div className="img-block left-column pc-20 mb-40 wow fadeInRight" data-wow-delay="0.6s">
                  <img className="img-fluid" src={img_01} alt="content-image" />
                </div>
              </div>
              {/* TEXT BLOCK */}	
              <div className="col-md-7 col-lg-6">
              ...
              <div className="col-lg-6">	
                <div className="download-6-txt pl-20 wow fadeInUp" data-wow-delay="0.6s">
                  ...
                  <div className="stores-badge">
                    {/* AppStore */}
                    <a href="#" className="store">
                      <img className="appstore" src={appstore_white} alt="appstore-badge" />
                    </a>
                    {/* Google Play */}
                    <a href="#" className="store">
                      <img className="googleplay" src={googleplay_white} alt="googleplay-badge" />
                    </a> 
                    {/* Aamazon Market 
                <a href="#" class="store">
                  <img class="amazon" src="images/amazon.png" alt="amazon-badge" />
            ...
            <div className="row">
              ...
              <div id="b-post-1" className="col-md-6 col-lg-4">
                <div className="blog-post mb-40 wow fadeInUp" data-wow-delay="0.4s">	
                  ...
                  <div className="blog-post-img">
                    <img className="img-fluid" src={post_1} alt="blog-post-image" />
              ...
              <div id="b-post-3" className="col-md-6 col-lg-4">
                <div className="blog-post mb-40 wow fadeInUp" data-wow-delay="0.8s">	
                  {/* BLOG POST IMAGE */}
                  <div className="blog-post-img">
                    <img className="img-fluid" src={post_1} post_author alt="blog-post-image" />
                  </div>
                  {/* BLOG POST TEXT */}
                  <div className="blog-post-txt">
                    {/* Post Tag */}
                ...
                <div className="row">
                  ...
                  <div className="col-sm-6 col-md-8 col-lg-3">
                    <div className="footer-store-badges text-right mb-40">
                      {/* AppStore */}
                      <a href="#" className="store">
                        <img className="appstore appstoreimg" src={appstore}  alt="appstore-badge" />
                      </a>
                      {/* Google Play */}
                      <a href="#" className="store">
                        <img className="googleplay" src={googleplay} alt="googleplay-badge" />
